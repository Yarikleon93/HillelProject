/**
 * Ничего делать в этом задании не нужно.
 * Можно воспользоваться этим кодом, чтобы увидеть таблицу с долгами по ДЗ.
 * Скорее всего я добавлю отображение баллов, но немного позже.
 *
